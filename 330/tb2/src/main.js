...
document.querySelector("#my-button").onclick = generateRandomizedTechnobabble;
...
function generateRandomizedTechnobabble() {
    let babble = `${getRandomWord(words1)} ${getRandomWord(words2)} ${getRandomWord(words3)}`;
